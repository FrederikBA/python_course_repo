...
def highest_grossing_disney_movies():
  disney_movies = df[df["Distributor"].str.contains("Walt Disney Studios Motion Pictures") == True]
...
def percentage_of_pg_rated_movies():
  ...
  #Year range
  year_range = ['2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013','2014']
  ...
  pg_rated_movies["Release Date"] = pg_rated_movies["Release Date"].str.split(',').str.get(-1).str.strip()
  ...
  all_licenses["Release Date"] = all_licenses['Release Date'].str.split(',').str.get(-1).str.strip()
  ...
  percentage_dict = {}
  for (k,v), (k2,v2) in zip(occurences_of_pg_rated.items(), occurences_of_all.items()):
    percentage = v / v2 * 100
